 ...
 * 
 */
@WebServiceClient(name = "HelloImplService", targetNamespace = "http://service/", wsdlLocation = "http://localhost:8082/hello?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8082/hello?wsdl");
